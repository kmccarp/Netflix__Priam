...
public class PgpCryptography implements IFileCryptography {
    ...
    public class EncryptedInputStream extends InputStream {
        ...
        private final ByteArrayOutputStream bos; // Handle to encrypted stream
        ...
        private final PGPCompressedDataGenerator
                compressedDataGenerator; // a means to compress data using PGP
        private final String fileName; // TODO: eliminate once debugging is completed.
